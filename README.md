...
Create an Account: Register a new user or log in with your superuser account.

Configure Settings: Go to the "Settings" tab.

Connect GitHub: Enter your Private GitHub Repository HTTPS URL (e.g., https://github.com/username/my-obsidian-vault.git) and your GitHub Personal Access Token (PAT) with repo scope.

Sync: Navigate to the "Notes" or "AI Chat" tab. The system will automatically clone your vault into an isolated secure folder and build the ChromaDB vector embeddings.

Ask the AI: Open Terminal Chat and start asking questions about your personal data!

🛡️ Security Notes
Never commit your .env file or db.sqlite3 to version control.

GitHub tokens are encrypted at rest in the SQLite database using your .env SECRET_KEY.
